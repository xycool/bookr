...
class Publisher(models.Model):
    """A company that published books."""
...
class Review(models.Model):
    ...
    date_edited = models.DateTimeField(null=True, help_text="The date and tiem the review was last edited.")
    createor = models.ForeignKey(auth.get_user_model(), on_delete=models.CASCADE)
